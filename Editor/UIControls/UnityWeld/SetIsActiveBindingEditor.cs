...
{
    [CustomEditor(typeof(SetIsActiveBinding))]
    public class SetIsActiveBindingEditor : BaseBindingEditor
    {
        private SetIsActiveBinding targetScript;
        ...
        {
            targetScript = (SetIsActiveBinding)target;
