...
namespace Battlehub.RTEditor.Views
{
    public class ToolsView : View
    {
        ...
        [SerializeField] private Toggle m_moveToggle = null;
        [SerializeField] private Toggle m_rotateToggle = null;
        ...
        [NonSerialized] public UnityEvent ViewChanged = new UnityEvent();
        ...
        [NonSerialized] public UnityEvent MoveChanged = new UnityEvent();
        ...
        [NonSerialized] public UnityEvent RotateChanged = new UnityEvent();
        ...
        [NonSerialized] public UnityEvent ScaleChanged = new UnityEvent();
        ...
        [NonSerialized] public UnityEvent RectChanged = new UnityEvent();
        ...
        [NonSerialized] public UnityEvent PivotRotationChanged = new UnityEvent();
        ...
        [NonSerialized] public UnityEvent PivotModeChanged = new UnityEvent();
        ...
        [NonSerialized] public UnityEvent PlayChanged = new UnityEvent();
        ...
        [NonSerialized] public UnityEvent Undo = new UnityEvent();
        ...
        [NonSerialized] public UnityEvent Redo = new UnityEvent();
