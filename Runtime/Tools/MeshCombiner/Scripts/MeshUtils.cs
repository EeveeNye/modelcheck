    ...
    public static partial class MeshUtils
    {
        ...
        public static CombineResult Combine(GameObject[] gameObjects, GameObject target = null)
        {
...
#if UNITY_EDITOR
            Undo.RecordObject(target, "SetActive(false)");
#endif
            ...
            if (colliderCombine.Count != 0)
            {
                ...
                {
                    Object.Destroy(colliderCombine[i].mesh);
                }
            ...
            {
                Object.Destroy(meshCombine[i].mesh);
            }
            ...
            Object.Destroy(intermediateMesh);
        ...
        public static Mesh RemoveRotation(Mesh mesh, Matrix4x4 targetRotationMatrix, bool merge)
        {
            ...
            for (int i = 0; i < combineInstances.Length; ++i)
            {
                ...
                removeRotation.mesh = mesh;
                removeRotation.subMeshIndex = i;
        ...
        public static bool BuildCombineInstance(Matrix4x4 targetToLocal, List<MeshFilter> allMeshFilters, List<SkinnedMeshRenderer> allSkinned,
        ...
        public static List<Mesh> GetColliderMeshes(GameObject obj)
        {
            ...
            else
            {
                for (int i = 0; i < allColliders.Length; ++i)
                {
                    ...
                    {
                        meshes.AddRange(Separate(meshCollider.sharedMesh));
                    }
                    else
                    {
